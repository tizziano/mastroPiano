...
image::docs/images/prototipo1-50.JPG["Prototipo1", width="300"]
...
image::docs/images/isometrica_v3.jpg["Modello"]
...
image::docs/images/prototipo2-50.JPG["Prototipo2", width="300"]
...
image::docs/images/prototipo3.JPG["Prototipo3", width="300"]
