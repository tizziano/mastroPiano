...
(link:https://github.com/tizziano/mastroPiano/raw/master/docs/risorse/downloads/opuscolo-mastropiano_170316.pdf[scaricabile da qui]), 
in cui riassumere brevemente ed esaustivamente tutto questo. Successivamente, 
